...
allow_over_H2 INTEGER,
over_H2_penalty_per_mw FLOAT,
allow_unserved_H2 INTEGER,
unserved_H2_penalty_per_mw FLOAT,
allow_over_ccs INTEGER,
over_ccs_penalty_per_tonne FLOAT,
allow_unserved_ccs INTEGER,
unserved_ccs_penalty_per_tonne FLOAT,
...
ccs_fixed_cost_per_tonne_year FLOAT,
...
min_cumulative_new_build_tonne FLOAT,
max_cumulative_new_build_tonne FLOAT,
...
variable_ccs_om_cost_per_tonne FLOAT,
ccs_mwh_per_tonne FLOAT,
ccs_efficiency FLOAT,
fuel VARCHAR(32),
...
tx_annualized_real_cost_per_tonne_yr FLOAT,
...
DROP TABLE IF EXISTS results_pipeline_operations;
CREATE TABLE results_pipeline_operations (
scenario_id INTEGER,
transmission_line VARCHAR(64),
load_zone_from VARCHAR(64),
load_zone_to VARCHAR(64),
...
number_of_hours_in_timepoint FLOAT,
spinup_or_lookahead INTEGER,
pipeline_flow_mw FLOAT,
pipeline_losses_lz_from FLOAT,
pipeline_losses_lz_to FLOAT,
PRIMARY KEY (scenario_id, transmission_line, subproblem_id, stage_id, timepoint)
);
...
DROP TABLE IF EXISTS results_pipeline_imports_exports_agg;
CREATE TABLE results_pipeline_imports_exports_agg (
scenario_id INTEGER,
load_zone VARCHAR(64),
period INTEGER,
subproblem_id INTEGER,
...
DROP TABLE IF EXISTS results_system_H2_balance;
CREATE TABLE results_system_H2_balance (
scenario_id INTEGER,
load_zone VARCHAR(32),
period INTEGER,
subproblem_id INTEGER,
...
Total_H2_Balance_Penalty_Costs Float,
Total_CCS_Balance_Penalty_Costs Float,
...
CASE WHEN of_ccs THEN 'yes' ELSE 'no' END AS
    feature_ccs,
