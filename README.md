...
"ccs_fixed_cost_per_tonne_year" --> the annualized capital cost (including fixed O&M) for capturing 1 tonne of CO2 by retrofitting the existing fossil fuel power plants

project/project_new_cost/.csv:
"annualized_real_cost_per_tonne_yr" --> the annualized cost (including fixed O&M) for capturing 1 tonne of CO2 by building a new fossil fuel power plant and CO2 storage facilities. Note that for power plants, this only refers to the CCS module.
