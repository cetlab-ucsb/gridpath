...
H2_balance_production_components = "H2_balance_production_components"
H2_balance_consumption_components = "H2_balance_consumption_components"

ccs_balance_production_components = "ccs_balance_production_components"
ccs_balance_consumption_components = "ccs_balance_consumption_components"
...
class DynamicComponents(object):
    ...
    def __init__(self):
        ...
        # Load balance constraint
        # Modules will add component names to these lists
        setattr(self, H2_balance_production_components, list())
        setattr(self, H2_balance_consumption_components, list())

        # ### Constraint and objective function components ### #
        # Load balance constraint
        # Modules will add component names to these lists
        setattr(self, ccs_balance_production_components, list())
        setattr(self, ccs_balance_consumption_components, list())
